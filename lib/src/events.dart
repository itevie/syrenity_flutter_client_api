...
class EvDispatchMessageUpdate extends SyEvent<SyMessage> {
  const EvDispatchMessageUpdate() : super("dispatch_message_update");
}
...
class EvDispatchTodoDelete extends SyEvent<int> {
  const EvDispatchTodoDelete() : super("dispatch_todo_delete");
}
...
class EvDispatchChannelCreate extends SyEvent<SyChannel> {
  const EvDispatchChannelCreate() : super("dispatch_channel_create");
}
...
class SyEvents {
  ...
  static final dispatchMessageCreate = EvDispatchMessageCreate();
  static final dispatchMessageUpdate = EvDispatchMessageUpdate();
  static final dispatchMessageDelete = EvDispatchMessageDelete();
  ...
  static final dispatchChannelCreate = EvDispatchChannelCreate();
